...
public class ConfigApp {
    ...
    public final static String PATCH_USER_URL = "api/auth/user";
    public final static String GET_ALL_ORDERS_URL = "api/orders/all";
    public final static String GET_USER_ORDERS_URL = "api/orders";
}
